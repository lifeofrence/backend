    ...
    <table class="w-full text-left border-collapse">
        ...
        <tbody class="divide-y divide-white/5">
            ...
            <tr class="hover:bg-white/[0.02] transition-colors">
                ...
                <td class="px-6 py-4 text-zinc-400 text-sm max-w-sm truncate">{{ $action->title }}</td>
                <td class="px-6 py-4 text-zinc-500 text-xs max-w-md truncate">{{ $action->summary }}</td>
            ...
            @empty
            <tr>
                <td colspan="5" class="px-6 py-8 text-center text-zinc-500 italic">No announcements found.</td>
            </tr>
            @endforelse
        </tbody>
    </table>
